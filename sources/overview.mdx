...
Each source reads raw bytes, applies a configured [`decoding`](/sources/decoding) policy, and emits structured records into Tangent’s pipeline.
...
* [Runtime Configuration](/cli/tangent-yaml#runtime)
