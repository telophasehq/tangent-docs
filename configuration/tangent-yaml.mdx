...
- [Plugins](/configuration/tangent-yaml/plugins)
...
See [Runtime](/configuration/tangent-yaml/runtime).

### Plugins

Define each WASM plugin (language, entry point, tests).
See [Plugins](/configuration/tangent-yaml/plugins).
...
See [DAG](/configuration/tangent-yaml/dag).
