...
* Sources: [MSK](/configuration/sources/msk), [Socket](/configuration/sources/socket), [File](/configuration/sources/file), [SQS](/configuration/sources/sqs)
* Pipeline wiring: [`dag`](/configuration/dag)
