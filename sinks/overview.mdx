...
See [Encoding](/sinks/common/encoding) for supported formats (`ndjson`, `json`, `avro`, `parquet`).
</ParamField>

<ParamField path="compression" type="object">
Configures compression for sink objects.  
See [Compression](/sinks/common/compression) for algorithm details and levels.
</ParamField>
...
* [Encoding](/sinks/common/encoding)
* [Compression](/sinks/common/compression)
